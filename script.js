...
let setStateResults = function(state) {
  ...
  // Gets at the table displaying individual states' results when states are moused over.
  ...
  candidate1Name.innerText = ;
  candidate1Results.innerText = "infinity";
  candidate2Name.innerText = "me";
  candidate2Results.innerText = "0";
  stateWinnerName.innerText = "you";
};
